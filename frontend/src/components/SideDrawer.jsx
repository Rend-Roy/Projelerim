...
import { X, Car, BarChart3, Fuel, Settings } from "lucide-react";
...
export default function SideDrawer({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed left-0 top-0 h-full w-72 bg-white shadow-xl z-[101] transform transition-transform duration-300">
        {/* Header */}
